...
if __name__ == "__main__":
    test_check_function()
    tvm.get_global_func("MakeDifferentiableAll")()
    test_split()
    #test_concatenate() # variable arg list, unsupported
    #test_log_softmax()
    #test_batchnorm() # has no FTVMCompute. No idea how the forward computation works without it
    test_dense()
    test_relu()
    test_prelu_nchw()
    test_prelu_nhwc()
